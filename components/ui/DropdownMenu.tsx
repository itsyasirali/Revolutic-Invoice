...
const variantItemClasses: Record<
  NonNullable<DropdownMenuItem["variant"]>,
  string
> = {
...
export const DropdownMenu: React.FC<DropdownMenuProps> = ({
  ...
  return (
    <div className="relative inline-block text-left" ref={containerRef}>
      ...
      {isOpen && (
        <div
          className={`absolute mt-2 ${width} ${alignmentClass} bg-white rounded-md shadow-xl border border-slate-200/80 py-1.5 z-50 animate-reveal transform origin-top-right ${className}`}
        >
