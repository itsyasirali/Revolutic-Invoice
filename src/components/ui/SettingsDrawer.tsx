...
export const SettingsDrawer: React.FC<SettingsDrawerProps> = ({ isOpen, onClose }) => {
    const [activeTab, setActiveTab] = useState<'general' | 'organization' | 'branding'>('general');
                ...
                <div className="w-screen max-w-md bg-white shadow-2xl border-l border-slate-200 flex flex-col animate-slide-left">
                    ...
                    <div className="flex border-b border-slate-200 px-6 bg-slate-50/50">
                        <button
                            ...
                            className={`py-3 px-3 text-xs font-semibold border-b-2 transition-colors cursor-pointer ${activeTab === 'general'
                        ...
                        <button
                            ...
                            className={`py-3 px-3 text-xs font-semibold border-b-2 transition-colors cursor-pointer ${activeTab === 'organization'
                                    ? 'border-primary text-primary'
                                    : 'border-transparent text-slate-600 hover:text-slate-900'
                                }`}
                        >
