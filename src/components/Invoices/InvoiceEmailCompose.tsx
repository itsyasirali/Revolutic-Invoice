                ...
                <div className="bg-white overflow-hidden">
                    ...
                    <div className="px-6 py-4 bg-gray-50/50 border-t border-gray-100">
                        ...
                        >
                            ...
                            <span className="text-sm font-medium text-gray-700">Attach Invoice PDF</span>
                        </div>
                        ...
                        {emailData.attachPDF && (
                            <div className="mt-3 ml-8 flex items-center gap-2 p-2 bg-white border border-gray-200 rounded-lg max-w-xs">
                                ...
                                <div className="flex-1 overflow-hidden">
                                    <p className="text-xs font-medium text-gray-700 truncate">Invoice-{invoice?.invoiceNumber}.pdf</p>
